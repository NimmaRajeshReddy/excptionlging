    	...
    	try 
    	{
	    	do 
	    	{
		        ...
		        case 1:
		        	...
		        	sintr simpleInterest = new sintr(initialPrincipalAmount, annualRateOfInterest, timeInYears);
		        	LOGGER.info("Simple Interest = " + simpleInterest.calculateSimpleInterest());
		        	break;
		        case 2:
		        	getCompoundInterestValues();
		        	cintr compoundInterest = new cintr(initialPrincipalAmount, annualRateOfInterest, timeInYears , compoundingFrequencyPerYear);
